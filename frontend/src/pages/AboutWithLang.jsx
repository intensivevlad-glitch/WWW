...
export default function AboutWithLang() {
  const { lang } = useLanguage();

  const content = {
    ua: {
      title: "Про наш благодійний фонд",
      subtitle: "Наш фонд об'єднує людей, які прагнуть перемогти рак крові. Ми допомагаємо пацієнтам, підтримуємо медичні заклади, організовуємо донорські ініціативи та фінансуємо закупівлю сучасного обладнання.",
      highlight: "Разом ми доводимо, що добро лікує.",
      cards: [
        { 
          img: team, 
          title: "Наша команда", 
      ...
      mission: {
        title: "Наша місія",
        text1: "Ми прагнемо створити світ, де кожен пацієнт з раком крові має доступ до якісного лікування, підтримки та надії на одужання.",
        text2: "Кожна пожертва, кожен волонтер і кожен донор — це частина великої мети:",
        highlight: "подарувати життя тим, хто бореться з хворобою",
        values: [
      ...
      cta: {
        ...
        desc: "Кожен внесок має значення. Станьте частиною руху, який рятує життя.",
        button1: "Підтримати фонд",
        button2: "Зв'язатися з нами"
      }
    },
    en: {
      title: "About Our Charity Foundation",
      subtitle: "Our foundation unites people who strive to defeat blood cancer. We help patients, support medical institutions, organize donor initiatives and fund the purchase of modern equipment.",
      highlight: "Together we prove that kindness heals.",
      cards: [
        { 
          img: team, 
          title: "Our Team", 
          desc: "A team of doctors, volunteers and coordinators who work daily to save lives.",
          icon: "👥"
        },
        { 
          img: lab, 
          title: "We Help Clinics", 
          desc: "The foundation supports hospitals by purchasing reagents, medicines and necessary equipment.",
          icon: "🏥"
        },
        { 
          img: heart, 
          title: "Trust & Transparency", 
          desc: "We openly report on every donation and the results of our activities.",
          icon: "✅"
        }
      ],
      mission: {
        title: "Our Mission",
        text1: "We strive to create a world where every blood cancer patient has access to quality treatment, support and hope for recovery.",
        text2: "Every donation, every volunteer and every donor is part of a great goal:",
        highlight: "give life to those fighting the disease",
        values: [
          { icon: "💪", title: "Strength in Unity", desc: "Together we can do more" },
          { icon: "❤️", title: "Compassion", desc: "We understand pain and provide support" },
          { icon: "🌟", title: "Hope", desc: "We believe in victory over disease" }
        ]
      },
      cta: {
        title: "Join Us",
        desc: "Every contribution matters. Become part of a movement that saves lives.",
        button1: "Support the Foundation",
        button2: "Contact Us"
      }
    }
  };
    ...
    <main className="pt-24 pb-20 bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="container max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          >
            {t.subtitle}{' '}
            <span className="text-red-600 font-semibold">{t.highlight}</span>
          </motion.p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                {t.mission.text2}{' '}
                <span className="text-red-600 font-semibold">{t.mission.highlight}</span>.
              </p>
            </div>
