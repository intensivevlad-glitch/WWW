...
const steps = [
  {
    ...
    descEn: "We accept charitable contributions from donors, partners, and organizations. Every hryvnia brings us closer to our goal — saving lives.",
    img: step1,
  },
  {
    title: "2️⃣ Аналіз потреб",
    titleEn: "2️⃣ Needs Analysis",
    ...
    descEn: "Medical coordinators and experts determine who urgently needs help — from purchasing medicines to funding treatment.",
    img: step2,
  },
  {
    title: "3️⃣ Закупівля та доставка",
    titleEn: "3️⃣ Purchase & Delivery",
    desc: "Фонд забезпечує швидке постачання медикаментів, обладнання та лабораторних реактивів до клінік по всій Україні.",
    descEn: "The foundation ensures rapid supply of medicines, equipment, and laboratory reagents to clinics across Ukraine.",
    img: step3,
  },
  {
    title: "4️⃣ Контроль і звітність",
    titleEn: "4️⃣ Control & Reporting",
    desc: "Ми звітуємо про кожен крок: опубліковані фінансові звіти, фото, історії пацієнтів, щоб зберегти довіру та прозорість.",
    descEn: "We report every step: published financial reports, photos, patient stories to maintain trust and transparency.",
    img: step4,
  },
];

export default function HowWeWorkNew() {
  return (
    <section id="work" className="py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        >
          Прозорий процес від пожертви до результату — кожен крок під контролем
        </motion.p>
